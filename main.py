...
AUTH_USER = os.environ.get('AUTH_USERS', '6568611832, 5487643307, 7510415010').split(',')
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/DrmBhai_Bot")]])
keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/TheRajBhaiOG"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com/cyberseller999/saini-txt-direct")],
])
